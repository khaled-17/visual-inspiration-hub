...
export default function MainLayout({children}) {
  ...
  return (
   ...
   <div>
 <div className="flex justify-between items-center mx-auto p-4 shadow-md  ">
      {/* left side */}
...
<footer className="flex border-2 p-3 text-black justify-center shadow-md  items-center   ">
  by 💖  khaled 
</footer>
